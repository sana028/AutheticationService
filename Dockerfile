...
WORKDIR /src
COPY ["NetCoreIntermediate/AuthenticationService.csproj", "NetCoreIntermediate/"]
RUN dotnet restore "./NetCoreIntermediate/AuthenticationService.csproj"
COPY . .
WORKDIR "/src/NetCoreIntermediate"
